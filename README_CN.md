...
- **工程级强类型与多语言支持**：全线基于 GDScript 2.0 静态强类型开发，无缝对接 `EditorUndoRedoManager`，内置支持中、英、日、韩、西、葡、俄 7 种语言 (i18n) 界面即时热切换。
...
| **国际化** | 仅支持单语言 | **原生多语言支持**（中、英、日、韩、西、葡、俄 7 语），自动跟随编辑器语言偏好并支持独立覆盖 |
...
### 简体中文
- [主说明文档 (README_CN.md)](README_CN.md)：插件核心特性、安装指南、快速上手与演进历史。
